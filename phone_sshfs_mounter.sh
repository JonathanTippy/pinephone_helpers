...
trap "fusermount -u -q ${PINEPHONE_SSHFS_PATH}; rm ${PINEPHONE_SSHFS_PATH} -d -f; rm /tmp/.pinephone_sshfs_wifi -f; rm /tmp/.pinephone_sshfs_new_connection_notified -f; exit" INT
